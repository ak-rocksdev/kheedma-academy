...
Route::controller(ApplicationController::class)->group(function () {
    ...
    Route::post('/program/{program:slug}/daftar', 'store')->middleware(['throttle:funnel', 'precognitive'])->name('program.apply.store');
});
...
Route::post('/komunitas', [CommunityController::class, 'join'])->middleware(['throttle:funnel', 'precognitive'])->name('komunitas.join');
